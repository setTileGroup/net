...
//生存必备
var cat_starter_kit_items = [["钻石头盔",310,0 ],["钻石胸铠",311,0 ],["钻石裤",312,0 ],["钻石靴",313,0 ],["钻石剑",276,0 ],["钻石铲",277,0 ],["钻石镐",278,0 ],["钻石锄头",293,0 ],["钻石斧",279,0 ],["指南针",345,0 ],["时钟",347,0 ],["工作台",58,0 ],["床",355,0 ],["火把",50,0 ],["橡木板",5,0]];
//建筑方块
var cat_building_items = [["石",1,0 ],["草",2,0 ],["泥土",3,0 ],["鹅卵石",4,0 ],["橡木板",5,0 ],["云杉板",5,1 ],["桦木板",5,2 ],["丛林板",5,3 ],["基石",7,0 ],["沙",12,0 ],["砾石",13,0 ],["橡木",17,0 ],["云杉木",17,1 ],["桦树",17,2 ],["丛林木",17,3 ],["玻璃",20,0 ],["青金石块",22,0 ],["砂岩",24,0 ],["凿砂岩",24,1 ],["平滑砂岩",24,2 ],["白羊毛",35,0 ],["橙色羊毛",35,1 ],["紫红羊毛", 35,2 ],["淡蓝色羊毛",35,3 ],["黄色羊毛",35,4 ],["石灰羊毛",35,5 ],["粉红羊毛",35,6 ],["灰色羊毛",35,7 ],["浅灰色羊毛",35,8 ],["青色羊毛",35,9 ],["紫色羊毛",35,10 ],["蓝色羊毛",35,11 ],["棕色羊毛",35,12 ],["绿色羊毛",35,13 ],["红色羊毛", 35,14 ],["黑色羊毛",35,15 ],["菱形块",57,0 ],["黄金块",41,0 ],["铁块",42,0 ],["煤块",173,0 ],["双石板",43,0 ],["双砂岩板",43,1 ],["双木板",43,2 ],["双鹅卵石板",43,3 ],["双砖板",43,4 ],["石板",44,0 ],["砂岩板",44,1 ],["木板",44,2 ],["橡木板",158,0 ],["云杉板",158,1 ],["白桦板",158,2 ],["丛林板",158,3 ],["铺路石样板",44,3 ],["砖板",44,4 ],["石砖板",44,5 ],["石砖",44,6 ],["石英板",44,7 ],["砖块",45,0 ],["幽冥砖",112,0 ],["苔藓鹅卵石",48,0 ],["黑曜石",49,0 ],["橡木楼梯",53,0 ],["鹅卵石楼梯",67,0 ],["楼梯砖",108,0 ],["石楼梯砖",109,0 ],["下楼梯砖",114,0 ],["砂岩楼梯",128,0 ],["云杉楼梯",134,0 ],["桦树楼梯",135,0 ],["丛林楼梯",136,0 ],["石英楼梯",156,0 ],["粘土块",82,0 ],["篱笆",85,0 ],["篱笆门",107,0 ],["地狱岩",87,0 ],["隐形基岩",95,0 ],["石砖",98,0 ],["苔藓石砖",98,1 ],["裂石砖",98,2 ],["玻璃",102,0 ],["毛刺草",253,0 ],["故障叶",254,0 ],["故障,石",255,0]];
//工具
var cat_tools_items = [["打火石",259,0 ],["弓",261,0 ],["箭",262,0 ],["剪刀",359,0 ],["钻石之剑",276,0 ],["钻石铲",277,0 ],["钻石镐",278,0 ],["钻石锄头",293,0 ],["钻石斧",279,0 ],["黄金之剑",283,0 ],["金铲",284,0 ],["金镐",285,0 ],["金锄",294,0 ],["金斧头",286,0 ],["铁剑",267,0 ],["铁铲",256,0 ],["铁十字镐",257,0 ],["铁锄",292,0 ],["铁斧",258,0 ],["剑石",272,0 ],["石头铲",273,0 ],["石镐",274,0 ],["石锄",291,0 ],["石斧",275,0 ],["木剑",268,0 ],["木铲",269,0 ],["木镐",270,0 ],["木锄",290,0 ],["木斧",271,0]];
//装备
var cat_equip_items = [["皮革头盔",298,0],["皮革胸甲",299,0],["皮革护腿",300,0],["皮革靴子",301,0],["锁链头盔",302,0],["锁链胸甲",303,0],["锁链护腿",304,0],["锁链靴子",305,0],["铁头盔",306,0],["铁胸甲",307,0],["铁护腿",308,0],["铁靴子",309,0],["钻石头盔",310,0],["钻石胸甲",311,0],["钻石护腿",312,0],["钻石靴子",313,0],["金头盔",314,0],["金胸甲",315,0],["金护腿",316,0],["金靴子",317,0]];
//食物
var cat_food_items = [["南瓜",86,0 ],["苹果",260,0 ],["褐蘑菇",39,0 ],["红蘑菇",40,0 ],["绿色野菌汤",282,0 ],["生猪肉",319,0 ],["熟猪排",320,0 ],["牛肉",363,0 ],["牛排",364,0 ],["生鸡",365,0 ],["煮熟的鸡",366,0 ],["蛋糕",354,0 ],["胡萝卜",391,0 ],["土豆",392,0 ],["焗马铃薯",393,0 ],["南瓜馅饼",400,0 ],["beet根",457,0 ],["甜菜根汤",459,0]];
//染色物
var cat_dyes_items = [["墨袋",351,0 ],["红玫瑰",351,1 ],["仙人掌绿",351,2 ],["可可豆",351,3 ],["青金石",351,4 ],["紫色",351,5 ],["青色",351,6 ],["灰色",351,7 ],["灰色",351,8 ],["粉红色",351,9 ],["石灰",351,10 ],["蒲公英黄",351,11 ],["蓝色",351,12 ],["品红",351,13 ],["橙色",351,14 ],["骨头",351,15]];
//矿物和非方块
var cat_items_items = [["钻石矿",56,0 ],["金矿",14,0 ],["铁矿石",15,0 ],["煤矿",16,0 ],["天青石矿",21,0 ],["红石矿",73,0 ],["红石矿",74,0 ],["钻石",264,0 ],["铁锭",265,0 ],["金锭",266,0 ],["木棍",280,0 ],["燧石",318,0 ],["碗",281,0 ],["骨",352,0 ],["蜘蛛丝",287,0 ],["皮革",334,0 ],["羽毛",288,0 ],["糖",353,0 ],["火药",289,0 ],["小麦",296,0 ],["面包",297,0 ],["矿车里",328,0 ],["供电轨",27,0 ],["轨道",66,0 ],["鞍",329,0 ],["雪球",332,0 ],["泥球",341,0 ],["蛋",344,0 ],["泥",337,0 ],["砖",336,0 ],["幽冥砖",405,0 ],["幽冥石英",406,0 ],["纸",339,0 ],["书",340,0 ],["指南针",345,0 ],["时钟",347,0 ],["红石粉末",348,0 ],["瓜片",360,0]];
//生物蛋
var cat_spawn_items = [["生存鸡",383,10 ],["生成牛",383,11 ],["生成猪",383,12 ],["生成羊",383,13]]
//各种各样的
		      var cat_miscellaneous_items = [["工作台",58,0 ],["炉",61,0 ],["燃烧的炉",61,0 ],["剪刀",245,0 ],["木箱",54,0 ],["火炬",50,0 ],["阶梯",65,0 ],["木门",324,0 ],["门",330,0 ],["天窗",96,0 ],["木牌",323,0 ],["床",355,0 ],["煤",263,0 ],["木炭",263,1 ],["橡树树苗",6,0 ],["云杉树苗",6,1 ],["桦树苗",6,2 ],["西瓜杆",105,0 ],["种子",295,0 ],["南瓜",361,0 ],["西瓜种子",362,0 ],["甜菜种子",458,0 ],["桶",325,0 ],["牛奶桶",325,1 ],["一桶水",325,8 ],["水",8,0 ],["静止的水",9,0 ],["熔岩桶",325,10 ],["熔岩",10,0 ],["静止的熔岩",11,0 ],["橡树的叶子",18,0 ],["云杉叶",18,1 ],["桦树的叶子",18,2 ],["丛林叶",18,3 ],["床",26,0 ],["蜘蛛网",30,0 ],["死灌木",31,0 ],["TNT",46,0 ],["火",51,0 ],["田",60,0 ],["幽冥堆芯",247,0 ],["摄像机",456,0]];

var cat=[[cat_starter_kit_items,"生存必备"],[cat_building_items,"建筑方块"],[cat_tools_items,"工具"],[cat_equip_items,"装备"],[cat_food_items,"食物"],[cat_dyes_items,"染色物"],[cat_items_items,"矿物和非方块"],[cat_spawn_items,"生物蛋"],[cat_miscellaneous_items,"各种混杂"]];
...
function useItem(x,y,z,i,b,s,id,bd)
{
	...
	if(i==347)
	{
		gyentity(x,y,z,entitychange);
	}
	if(i==345)
	{
		clientMessage("位置: x="+x+",y="+y+",z="+z+",Id="+b+",bd="+bd+"\n"+"距上次查询，x="+
			      (x-last[0])+",y="+(y-last[1])+",z="+(z-last[2])+",净距离="+
			      Math.floor(Math.sqrt((last[0]-x)*(last[0]-x)+(last[1]-y)*(last[1]-y)+(last[2]-z)*(last[2]-z))*100)*0.01);
		last=[x,y,z];
	}
	if(i<256)
	{
...
function entityAddedHook(ent)
{
	...
	if(s!=0)
	{
		for(var ssss in entstop)
		{
			if(entstop[ssss][0]==true&&entstop[ssss][1]==true)
			{
				Entity.remove(ent);
				break;
			}
			else if(entstop[ssss][0]==s&&entstop[ssss][1]==true)
			{
				Entity.remove(ent);
				break;
			}
...
function set(x,y,z,u)
{
	var mt=getTile(x,y,z);
	var vm=Level.getData(x,y,z);
	ctx.runOnUiThread(new java.lang.Runnable(
	{
run: function()
		{
...
run: function()
				{
					l=parseInt(l);
					var j=parseInt(jg);
					var nt=getTile(x,y,z);
					var vt=Level.getData(x,y,z);
					if(u==0)
					{
						nt=0;
						vt=0;
...
function openMenu()
{
	try
	{
		...
		stitle.setText("6g3y minecraftpe吧");
...
  onClick:function(viewarg)
			{
				...
				{
					setblockwithout0(x1.getText(),y1.getText(),z1.getText());
				}
				if(menu!=null)
					menu.dismiss();
				menu=null;
...
function inputr(nau)
{
	...
	try
	{
		...
		tmiLayout.setOrientation(android.widget.LinearLayout.VERTICAL);
		if(nau<12||nau==13||nau==81||nau==82)
		{
			tmiLayout.addView(id);
		}
...
//名称
		...
		var s=new android.widget.TextView(ctx);
		s.setTextSize(15);
		s.setText("本页面要内容求在有限算法之内完成，否则会卡死，建议强度2000以下，在有限算法之内无论取多少都没有问题");
		s.setTextColor(android.graphics.Color.rgb(255,255,255));
		s.setLayoutParams(textParams);
		layout.addView(s);
...
function setv()
{
	...
	try
	{
		...
		add.setText("确认");
		id.setHint("20为默认(速度/20=普通速度的倍数)");
...
onClick:
			function(p1)
			{
				...
				if(vs<256)
				{
					Entity.setHealth(getplayerent(),vs);
				}
/////
				tmiDialog.dismiss();
			}
...
function makebutton3(ctx,layout,m,a)
{
	var button=new android.widget.TextView(ctx);
	button.setText(a[m][0]+String(a[m][1])+":"+String(a[m][2]));
...
onClick:
			...
			{
//Entity.setCarriedItem(getplayerent(),a[m][1],1,a[m][2]);
				Player.addItemInventory(a[m][1],id.getText(),a[m][2]);
				tmiDialog.dismiss();
			}
		});
		tmiDialog.show();
...
onClick:
			function(p1)
			{
				...
				{
					h=parseInt(String(id2.getText()))-1;
				}
				pt=true;
/////
				tmiDialog.dismiss();
...
onCheckedChanged:
			...
			var s=new android.widget.TextView(ctx);
			s.setTextSize(16);
			s.setText("说明必看:下面的都要填写，写出旋转角度，角度的起始边在Z+上，按照y+进行右手定则旋转，沿着该方向延长生成，并且填写长度(矿洞长度)，巨洞生成按半径计算");
...
{
	var button=new android.widget.TextView(ctx);
	button.setText(String(a[0])+"(这1秒内) 个数:"+String(a.length-1));
	button.setTextSize(18);
	button.setTextColor(android.graphics.Color.rgb(255,255,255));
	button.setOnClickListener(new android.view.View.OnClickListener(
	{
...
//clientMessage(Level.getTime())
	if(pl[0]==1)
		fpl();
	if(dx==1)
		fdx(Entity.getX(getplayerent()),Entity.getY(getplayerent()),Entity.getZ(getplayerent()));
	running();
}
	...
	if(pl[1]==false)
	{
		if(Player.getCarriedItem()<256)
		{
			for(var i=-pl[3]; i<=pl[3]; i++)
			{
				...
				{
					if(i*i+j*j<=pl[3]*pl[3])
						settile(x+i,y-2,z+j,Player.getCarriedItem(),Player.getCarriedItemData());
				}
			}
		}
	}
...
//连线
		...
		if(cub==5)
		{
			...
			else if(s2==false)
			{
				s2=[x,y,z];
				print2("开始替换");
				replaces(s1[0],s1[1],s1[2],s2[0],s2[1],s2[2]);
				cleans();
				cub=0;
			}
		}
		...
		if(cub==6)
		{
			...
			else if(s2==false)
			{
				s2=[x,y,z];
				print2("开始替换");
				replaces2(s1[0],s1[1],s1[2],s2[0],s2[1],s2[2]);
				cleans();
				cub=0;
			}
		}
...
//三点一面
		...
		if(g==3)
		{
			...
			else if(s2==false)
			{
				s2=[x,y,z];
				print2("ok");
				settile((s1[0]+s2[0])*0.5,(s1[1]+s2[1])*0.5,(s1[2]+s2[2])*0.5,i,id);
				cleans();
				geotype=0;
			}
		}
		...
		if(g==4)
		{
			...
			{
				s3=[x,y,z];
				print2("设置点Z面,放置"+s3[0]+","+s1[1]+","+s2[2]);
				settile(s3[0],s1[1],s2[2],i,id);
				cleans();
				geotype=0;
			}
		}
...
function alloffzzt(x,y,z,i)
{
	if(swifz!=false)
	{
		if(i==0)
		{
			...
			{
				setblockwithout0(x,y,z);
				swifz=false;
			}
			else if(swifz==3)
			{
				setblockwithout3(x,y,z);
				swifz=false;
			}
			else if(swifz==4)
			{
				setblockwithout4(x,y,z);
				swifz=false;
			}
			else if(swifz==5)
			{
				setblockwithout5(x,y,z);
				swifz=false;
			}
			else if(swifz==6)
			{
				setblockwithout6(x,y,z);
				swifz=false;
			}
			else if(swifz==7)
			{
				setblockwithout7(x,y,z);
				swifz=false;
			}
			else if(swifz==8)
			{
				setblockwithout8(x,y,z);
				swifz=false;
			}
			else if(swifz==9)
			{
				setblockwithout9(x,y,z);
				swifz=false;
			}
			else if(swifz==10)
			{
				setblockwithout10(x,y,z);
				swifz=false;
			}
			else if(swifz==11)
			{
				setblockwithout11(x,y,z);
				swifz=false;
			}
			else if(swifz==12)
			{
				setblockwithout12(x,y,z);
				swifz=false;
			}
			else if(swifz==13)
			{
				setblockwithout13(x,y,z);
				swifz=false;
			}
			else if(swifz==14)
			{
				setblockwithout14(x,y,z);
				swifz=false;
			}
			else if(swifz==15)
			{
				setblockwithout15(x,y,z);
				swifz=false;
			}
			else if(swifz==16)
			{
			...
			{
				copyblock(swifz[0],swifz[1],swifz[2],x,y,z);
				swifz=false;
			}
		}
	}
	...
	for(x in n)
	{
		for(y in n[x])
		{
			for(z in n[x][y])
			{
				if(isfg)
				{
					if(getTile(parseInt(a)+parseInt(x),parseInt(b)+parseInt(y),parseInt(c)+parseInt(z))==0)
					{
		...
		for(y in n[x])
		{
			for(z in n[x][y])
			{
				if(n[x][y][z][0]!=0)
				{
					if(isfg)
					{
						if(getTile(parseInt(a)+parseInt(n.length)-1-parseInt(x),parseInt(b)+parseInt(y),parseInt(c)+parseInt(z))==0)
						{
		...
		for(y in n[x])
		{
			for(z in n[x][y])
			{
				if(n[x][y][z][0]!=0)
				{
					if(isfg)
					{
						if(getTile(parseInt(a)+parseInt(x),parseInt(b)+parseInt(n[x].length)-1-parseInt(y),parseInt(c)+parseInt(z))==0)
						{
		...
		for(y in n[x])
		{
			for(z in n[x][y])
			{
				if(n[x][y][z][0]!=0)
				{
					if(isfg)
					{
						if(getTile(parseInt(a)+parseInt(x),parseInt(b)+parseInt(y),parseInt(c)+parseInt(n[x][y].length)-1-parseInt(z))==0)
						{
		...
		for(y in n[x])
		{
			for(z in n[x][y])
			{
				if(n[x][y][z][0]!=0)
				{
					if(isfg)
					{
						if(getTile(parseInt(a)+parseInt(n.length)-1-parseInt(x),parseInt(b)+parseInt(y),parseInt(c)+parseInt(n[x][y].length)-1-parseInt(z))==0)
						{
		...
		for(y in n[x])
		{
			for(z in n[x][y])
			{
				if(n[x][y][z][0]!=0)
				{
					if(isfg)
					{
						if(getTile(parseInt(a)+parseInt(z),parseInt(b)+parseInt(y),parseInt(c)+parseInt(n.length)-1-parseInt(x))==0)
						{
		...
		for(y in n[x])
		{
			for(z in n[x][y])
			{
				if(n[x][y][z][0]!=0)
				{
					if(isfg)
					{
						if(getTile(parseInt(a)+parseInt(n[x][y].length)-1-parseInt(z),parseInt(b)+parseInt(y),parseInt(c)+parseInt(x))==0)
						{
		...
		for(y in n[x])
		{
			for(z in n[x][y])
			{
				if(n[x][y][z][0]!=0)
				{
					if(isfg)
					{
						if(getTile(parseInt(a)+parseInt(x),parseInt(b)+parseInt(z),parseInt(c)+parseInt(n[x].length)-1-parseInt(y))==0)
						{
		...
		for(y in n[x])
		{
			for(z in n[x][y])
			{
				if(n[x][y][z][0]!=0)
				{
					if(isfg)
					{
						if(getTile(parseInt(a)+parseInt(x),parseInt(b)+parseInt(n[x].length)-1-parseInt(y),parseInt(c)+parseInt(n[x][y].length)-1-parseInt(z))==0)
						{
		...
		for(y in n[x])
		{
			for(z in n[x][y])
			{
				if(n[x][y][z][0]!=0)
				{
					if(isfg)
					{
						if(getTile(parseInt(a)+parseInt(x),parseInt(b)+parseInt(n[x][y].length)-1-parseInt(z),parseInt(c)+parseInt(y))==0)
						{
		...
		for(y in n[x])
		{
			for(z in n[x][y])
			{
				if(n[x][y][z][0]!=0)
				{
					if(isfg)
					{
						if(getTile(parseInt(a)+parseInt(n[x].length)-1-parseInt(y),parseInt(b)+parseInt(x),parseInt(c)+parseInt(z))==0)
						{
		...
		for(y in n[x])
		{
			for(z in n[x][y])
			{
				if(n[x][y][z][0]!=0)
				{
					if(isfg)
					{
						if(getTile(parseInt(a)+parseInt(n.length)-1-parseInt(x),parseInt(b)+parseInt(n[x].length)-1-parseInt(y),parseInt(c)+parseInt(z))==0)
						{
		...
		for(y in n[x])
		{
			for(z in n[x][y])
			{
				if(n[x][y][z][0]!=0)
				{
					if(isfg)
					{
						if(getTile(parseInt(a)+parseInt(y),parseInt(b)+parseInt(n.length)-1-parseInt(x),parseInt(c)+parseInt(z),n[x][y][z][0])==0)
						{
					...
					for(var m=0; m<bigs; m++)
					{
						for(var l=0; l<bigs; l++)
						{
							for(var o=0; o<bigs; o++)
							{
								if(isfg)
								{
									if(getTile(parseInt(a)+parseInt(x)*bigs+m,parseInt(b)+parseInt(y)*bigs+l,parseInt(c)+parseInt(z)*bigs+o)==0)
									{
...
function chickround(x,y,z,b,bd)
{
	if(crd!=null)
	{
		...
		{
		case 0:
			ycircle(x,y,z,r,b,bd);
			break;
		case 1:
			xcircle(x,y,z,r,b,bd);
			break;
		case 2:
			zcircle(x,y,z,r,b,bd);
			break;
		case 3:
			yround(x,y,z,r,b,bd);
			break;
		...
		case 5:
			...
			break;
		case 6:
			unsphere(x,y,z,r,b,bd);
			break;
		case 7:
			sphere(x,y,z,r,b,bd);
			break;
		case 8:
			yuanzhuy(x,y,z,r,b,bd);
			break;
		case 81:
			yuanzhux(x,y,z,r,b,bd);
			break;
		case 82:
			yuanzhuz(x,y,z,r,b,bd);
			break;
		case 9:
			yuanzhui(x,y,z,r,b,bd);
			break;
		case 10:
			yuantai(x,y,z,r,b,bd);
			break;
		case 11:
			tiankeng(x,y,z,stre,b,bd);
			break;
		case 12:
			jinzita(x,y,z,h,b,bd);
			break;
		case 13:
			halfsphere(x,y,z,r,b,bd);
			break;
		case 14:
			ycircleround(x,y,z,r,h,b,bd);
			break;
		case 15:
			xcircleround(x,y,z,r,h,b,bd);
			break;
		case 16:
			zcircleround(x,y,z,r,h,b,bd);
			break;
		case 17:
			shanmai(x,y,z,stre,b,bd);
			break;
		case 18:
			yanchangy(x,y,z,stre,b,bd);
			break;
		case 19:
			yanchangx(x,y,z,stre,b,bd);
			break;
		case 20:
			yanchangz(x,y,z,stre,b,bd);
			break;
		case 21:
			s1=[x,y,z];
			s2=[x+cubt[0],y+cubt[1],z+cubt[2]];
			cuboid1(b,bd);
			break;
		case 22:
			s1=[x,y,z];
		...
		case 23:
			...
			break;
		case 24:
			tuosphere(x,y,z,b,bd);
			break;
		case 101:
			manshe(x,y,z,stre,b,bd);
			break;
		case 102:
			shentou(x,y,z,stre,b,bd);
			break;
		case 103:
			shentou2(xx,yy,zz,stre,b,bd,getTile(xx,yy,zz),getData(xx,yy,zz));
			break;
		case 104:
			tiankengy(x,y,z,stre,b,bd);
			break;
		case 105:
			tiankengx(x,y,z,stre,b,bd);
			break;
		case 106:
			tiankengz(x,y,z,stre,b,bd);
			break;
		case 107:
			dbxy(x,y,z,r,h,bz,b,bd);
			break;
		case 108:
			dbxx(x,y,z,r,h,bz,b,bd);
			break;
		case 109:
			dbxz(x,y,z,r,h,bz,b,bd);
			break;
		case 201:
			tree1(x,y,z,b,bd);
			break;
...
function tuosphere(x,y,z,ib,bd)
{
	...
	for(var i=-r; i<=r; i++)
	{
		for(var j=-r; j<=r; j++)
		{
			...
			{
				if(i*i+j*j+k*k<=r*r&&i*i+j*j+k*k>=(r-1)*(r-1))
					settile(x+i*a,y+k*b,z+j*c,ib,bd);
			}
		}
	}
}
...
////
		...
		for(var m=rs; m>=0; m--)
		{
			for(var i=-rs; i<=rs; i++)
			{
				for(var j=-rs; j<=rs; j++)
				{
					...
					if(u<=h)
					{
						if(i*i+j*j<=(rs-m)*(rs-m)&&i*i+j*j>=((rs-m)-1)*((rs-m)-1))
							settile(x+i,y+h-u,z+j,b,bd);
					}
				}
			}
		}
	...
	{
		yuanzhu(x,y,z,r,b,bd);
	}
}


function jinzita(x,y,z,h,id,bd)
{
	for(var j=0; j<=h; j++)
	{
		...
		{
			var m=h-j;
//settile(x+m,y+j,z+m,id,bd)
			settile(x+m,y+j,z-m+a,id,bd);
			settile(x-m+a,y+j,z+m,id,bd);
			settile(x-m+a,y+j,z-m,id,bd);
			settile(x-m,y+j,z-m+a,id,bd);
		}
	}
		...
		for(sss in mz)
		{
			...
			case 0:
				if(getTile(x-1,y,z)==0)
					tiankeng(x-1,y,z,l-random,id,bd);
				break;
			case 1:
				if(getTile(x+1,y,z)==0)
					tiankeng(x+1,y,z,l-random,id,bd);
			...
			case 2:
				if(getTile(x,y,z-1)==0)
					tiankeng(x,y,z-1,l-random,id,bd);
				break;
			case 3:
				if(getTile(x,y,z+1)==0)
					tiankeng(x,y,z+1,l-random,id,bd);
				break;
			case 4:
				if(getTile(x,y-1,z)==0&&y>0)
					tiankeng(x,y-1,z,l-random,id,bd);
				break;
			case 5:
				x+=1;
				break;
...
function shanmai(x,y,z,l,id,bd)
{
	...
	if(l>=0)
	{
		...
		for(sss in mz)
		{
			...
			case 0:
				if(getTile(x-1,y,z)==0)
					shanmai(x-1,y,z,l-random,id,bd);
				break;
			case 1:
				if(getTile(x+1,y,z)==0)
					shanmai(x+1,y,z,l-random,id,bd);
			...
			case 2:
				if(getTile(x,y,z-1)==0)
					shanmai(x,y,z-1,l-random,id,bd);
				break;
			case 3:
				if(getTile(x,y,z+1)==0)
					shanmai(x,y,z+1,l-random,id,bd);
				break;
			case 4:
				if(getTile(x,y+1,z)==0&&y<128)
					shanmai(x,y+1,z,l-random,id,bd);
				break;
			case 5:
				if(getTile(x,y-1,z)==0&&y>0)
					shanmai(x,y-1,z,l-random,id,bd);
	...
	if(l>=0)
	{
		...
		for(sss in mz)
		{
			...
			case 0:
				n=getTile(x-1,y,z);
				m=getData(x-1,y,z);
				if(n!=0&&n!=95&&(n!=id||m!=bd))
					shentou(x-1,y,z,l-Math.random(),id,bd);
				break;
			case 1:
				n=getTile(x+1,y,z);
				m=getData(x+1,y,z);
			...
			case 2:
				...
				m=getData(x,y-1,z);
				if(n!=0&&n!=95&&(n!=id||m!=bd))
					shentou(x,y-1,z,l-Math.random(),id,bd);
				break;
			case 3:
				n=getTile(x,y+1,z);
				m=getData(x,y+1,z);
			...
			case 4:
				...
				m=getData(x,y,z-1);
				if(n!=0&&n!=95&&(n!=id||m!=bd))
					shentou(x,y,z-1,l-Math.random(),id,bd);
				break;
			case 5:
				n=getTile(x,y,z+1);
				m=getData(x,y,z+1);
		...
		if(l>=0)
		{
			...
			for(sss in mz)
			{
				...
				case 0:
					...
					m=getData(x-1,y,z);
					if(n!=0&&(n!=id||m!=bd))
						shentou2(x-1,y,z,l-Math.random(),id,bd,f,g);
					break;
				case 1:
					n=getTile(x+1,y,z);
					m=getData(x+1,y,z);
				...
				case 2:
					...
					m=getData(x,y-1,z);
					if(n!=0&&(n!=id||m!=bd))
						shentou2(x,y-1,z,l-Math.random(),id,bd,f,g);
					break;
				case 3:
					n=getTile(x,y+1,z);
					m=getData(x,y+1,z);
				...
				case 4:
					...
					m=getData(x,y,z-1);
					if(n!=0&&(n!=id||m!=bd))
						shentou2(x,y,z-1,l-Math.random(),id,bd,f,g);
					break;
				case 5:
					n=getTile(x,y,z+1);
					m=getData(x,y,z+1);
	...
	for(var i=-rs; i<=rs; i++)
	{
		for(var j=-rs; j<=rs; j++)
		{
			for(var k=-rs; k<=rs; k++)
			{
				...
				if(g<=q+r+0.9&&g>=q+r-0.9)
					settile(a+i,b+j,c+k,is,ids);
			}
		}
	}
}
...
function tiankengx(x,y,z,l,id,bd)
{
	...
	if(l>=0)
	{
		...
		for(sss in mz)
		{
			...
			case 0:
				if(getTile(x,y,z-1)==0)
					tiankengx(x,y,z-1,l-random,id,bd);
				break;
			case 1:
				if(getTile(x,y,z+1)==0)
					tiankengx(x,y,z+1,l-random,id,bd);
				break;
			case 2:
				if(getTile(x,y+1,z)==0&&y<255)
					tiankengx(x,y+1,z,l-random,id,bd);
				break;
			case 3:
				if(getTile(x,y-1,z)==0&&y>0)
					tiankengx(x,y-1,z,l-random,id,bd);
...
function tiankengz(x,y,z,l,id,bd)
{
	...
	if(l>=0)
	{
		...
		for(sss in mz)
		{
			...
			case 0:
				if(getTile(x-1,y,z)==0)
					tiankengz(x-1,y,z,l-random,id,bd);
				break;
			case 1:
				if(getTile(x+1,y,z)==0)
					tiankengz(x+1,y,z,l-random,id,bd);
			...
			case 2:
				if(getTile(x,y+1,z)==0&&y<255)
					tiankengz(x,y+1,z,l-random,id,bd);
				break;
			case 3:
				if(getTile(x,y-1,z)==0&&y>0)
					tiankengz(x,y-1,z,l-random,id,bd);
...
function tiankengy(x,y,z,l,id,bd)
{
	...
	if(l>=0)
	{
		...
		for(sss in mz)
		{
			...
			case 0:
				if(getTile(x,y,z-1)==0)
					tiankengy(x,y,z-1,l-random,id,bd);
				break;
			case 1:
				if(getTile(x,y,z+1)==0)
					tiankengy(x,y,z+1,l-random,id,bd);
			...
			case 2:
				if(getTile(x+1,y,z)==0)
					tiankengy(x+1,y,z,l-random,id,bd);
				break;
			case 3:
				if(getTile(x-1,y,z)==0)
					tiankengy(x-1,y,z,l-random,id,bd);
...
function picture(bitmap,rgb,h1,w1,h2,w2,ub,usb)
{
	...
	var sb=[];
	var sc=[];
	for(var js=0; js<h2-h1; js=js+ub)
	{
		sc=[];
...
var rbgblock=[[35,0],[35,8],[35,7],[35,15],[35,12],[35,14],[35,1],[35,4],[35,5],[35,13],[35,9],[35,3],[35,11],[35,10],[35,6],[41,0],[42,0],[57,0],[24,2],[3,0],[5,1],[5,0],[5,2],[5,3],[112,0],[49,0],[82,0],[155,0],[87,0]];
var blr=[220,180,60,0,80,255,200,220,90,60,60,125,60,140,220,255,230,140,190,140,100,160,180,180,25,0,160,255,100];
var blb=[220,180,60,0,60,0,140,200,170,80,120,0,60,80,160,255,230,190,190,100,80,140,160,140,25,0,160,255,0];
var blg=[220,180,60,0,45,0,55,40,65,5,145,205,125,165,185,0,230,255,150,10,50,65,125,85,25,65,145,255,0];
...
function gyrgb(R,G,B)
{
	...
	for(fx in rbgblock)
	{
		l[fx]=(Math.sqrt((R-blr[fx])*(R-blr[fx])+ (G-blg[fx])*(G-blg[fx])+ (B-blb[fx])*(B-blb[fx])));
	}
...
function caves(x,y,z,cave,tt)
{
	...
	for(var u=0; u<=ls; u+=i)
	{
		...
		for(var m=0; m<=l; m++)
		{
			...
			if(v!=0&&v!=95)
				fdx(Math.round(x+m/l*(x2-x)),Math.round(y+m/l*(y2-y)),Math.round(z+m/l*(z2-z)));
		}////
		s1=[s2[0],s2[1],s2[2]];
	}
	if(cave[3][0])
	{
		...
		for(var i=-l; i<=l; i+=2)
		{
			for(var j=-l; j<=l; j+=2)
			{
				...
				{
					if(getTile(x+i,y-1,z+j)!=0)
					{
						fdx(x+i,y-1+2*Math.random(),z+j);
					}
				}
				if(i*i+j*j<=Math.pow(l-0.5*l*Math.random(),2))
				{
					if(getTile(x+i,y+3,z+j)!=0)
					{
						fdx(x+i,y+3+2*Math.random(),z+j);
					}
				}
			}
		}
		if(getTile(s2[0],s2[1]-4,s2[2])!=0&&cave[3][2]&&Math.random()>0.5)
			tiankengy(s2[0],s2[1],s2[2],l*0.6,11,0);
	}
	else if(cave[3][2])
	{
...
function qiuling(x,y,z,r,l)
{
	...
	for(var m=-r; m<r; m++)
	{
		for(var n=-r; n<r; n++)
		{
			var ls=(Math.cos(pi*m/r)*Math.cos(pi*n/r))*l-(Math.sin(pi*m*a/r+b)*Math.cos(pi*n*a/r+c))*l*0.25+
			       (Math.cos(pi*m*a*2/r+b*d)+Math.sin(pi*n*a*2/r+c*d))*l*0.2-(Math.sin(pi*m*a*3/r+b*d*2)*Math.sin(pi*n*a*3/r+c*d*2))*l*0.15;
			if(ls>0)
