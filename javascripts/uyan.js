        ...
        if (typeof(w.uyan_loaded) == 'undefined') {
            w.UYAN = {
                ...
                getSu: function() {
                    var a = location.href,
                        loc = a.indexOf('#'),
                        al = d.getElementsByTagName('link'),
                        am = d.getElementsByTagName('meta'),
                        p = /\?p=\d+$/,
                        du = UYAN.getDu();
                ...
                cmtCUD: function(a, b) {
                    var c = d.getElementById('uyan_cu_' + b),
                        cuw = d.getElementById('uyan_cuw_' + b),
                        cd = d.getElementById('uyan_cd_' + b),
                        cdw = d.getElementById('uyan_cdw_' + b),
                        cun = p(c.innerHTML == '' ? 0 : c.innerHTML),
                        cdn = p(cd.innerHTML == '' ? 0 : cd.innerHTML);
                    if (a == 'uu') {
                        c.innerHTML = cun + 1;
                ...
                hidIntro: function(e, a) {
                    var b = UYAN.getWH(e.parentNode),
                        sm = d.getElementById('uyan_smile' + (a != null ? '_' + a : '')),
                ...
                shoSmile: function(e, t, a) {
                    var b = '',
                        cs = a != null ? '_' + a : '',
                        ss = d.getElementById('uyan_ssmile' + cs),
                        ssd = d.getElementById('uyan_ssmile_df' + cs),
                        ssa = d.getElementById('uyan_ssmile_al' + cs),
                        ssl = d.getElementById('uyan_ssmile_list' + cs);
                    ss.style.display = '';
                    if (t == 'al') {
                ...
                cmty: function() {
                    UYAN.showBox();
                    var c = d.getElementById('uyan_cmty'),
                        bc = d.getElementById('uyan_box_cnt');
                ...
                cmtSort: function(a, t) {
                    var b = d.getElementById('uyan_sort_box'),
                        sn = d.getElementById('uyan_sort_name'),
                        st = d.getElementById('uyan_sort_time'),
                        sh = d.getElementById('uyan_sort_hot');
                    if (a != null) {
                        if (t != null) {
                            UYAN.ct = t;
                            UYAN.reqItf({
                    ...
                    try {
                        var c = d.getElementById('uyan_sort_tsina'),
                            stq = d.getElementById('uyan_sort_tqq');
                        if (t == 'tsina') {
                ...
                login: function() {
                    UYAN.showBox();
                    var l = d.getElementById('uyan_login'),
                        bc = d.getElementById('uyan_box_cnt');
                ...
                logoutCU: function() {
                    var u = UYAN.conf.ufrom == 'sso' && UYAN.conf.dslogout ? UYAN.conf.dslogout : location.href,
                        loc = u.indexOf('#');
